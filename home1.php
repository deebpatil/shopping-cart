...
<button class="btn btn-primary btn-space " > 
   ...
   <div class="navbar-nav">
	 <a href="home.php" class="nav-item nav-link active text-white">
...
<div class="container-fluid">
 <div class="row">
    <div class="col-sm-2" style="background:black;text:white;text-align:center;padding:3px;text:justify;">
      ...
      <p><a href="lap1.php" class="text-white p-4">Laptops</a><br></p>
      <p> <a href="tab1.php" class="text-white">Tablets</a><br></p>
      <p> <a href="mob1.php" class="text-white">Mobiles</a><br></p>
      <p><a href="hdpn1.php" class="text-white">Headphones</a><br></p>
      <p> <a href="lap1.php" class="text-white">Laptops</a><br></p>
    </div>
    <div class="col-sm-10">
	...
	$query = " SELECT `id`,`name`, `pcode`,`image`, `price`, `discount` FROM `product` order by id ASC ";
